...
namespace CMAP_SISTEMAS_MVC.Models.ViewModels
{
    public class SociosIndexVM
    {
        /* ==== Entrada ===*/
        [Required(ErrorMessage = "Ingresa Clave de Pension.")]
        [StringLength(10, ErrorMessage = "La ClavePension debe tener maximo 10 Caracteres.")]
        public string ClavePension { get; set; }
        public string Nombre { get; set; }
        public string Apellidos { get; set; }

        /* === Resultado === */
        public SocioResultadoVM Socio { get; set; }
        public string? Mensaje { get; set; }
        public string TipoMensaje { get; set; }
    }

    public class SocioResultadoVM
    {
        public string? ClavePension { get; set; }
